    ...
    for index in range(len(nums) - 2):
        ...
        while left < right: 
            ...
            if threeSum == 0: 
                ...
                left += 1
                right -= 1
                # Check pointers for duplicates. We can get away with only incrementing one side as we will create an inequality that will only change if the duplicate number changes. 
